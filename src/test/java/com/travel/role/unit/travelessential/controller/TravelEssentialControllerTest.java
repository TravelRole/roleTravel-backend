...
class TravelEssentialControllerTest extends ControllerTestSupport {
	...
	class CreateTravelEssentials {
		...
		@DisplayName("존재하지 않는 방이면 예외를 발생시킨다.")
		@Test
		...
		@DisplayName("방에 속해 있지 않은 회원이면 예외를 발생시킨다.")
		@Test
		...
		@DisplayName("카테고리를 잘못 입력했다면 예외를 발생시킨다.")
		@NullAndEmptySource
		@CsvSource({"invalid"})
		@ParameterizedTest
		...
		@DisplayName("준비물 이름을 잘못 입력했다면 예외를 발생시킨다.")
		@EmptySource
		...
		@DisplayName("준비물 이름을 입력하지 않았다면 예외를 발생시킨다.")
		@Test
