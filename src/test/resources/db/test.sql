...
insert into room_info(room_id, created_at, location, room_expired_time, room_image, room_invite_code, room_name, travel_end_date, tarvel_start_date)
values (1, '2023-01-03 09:00:00', '가평군', '2023-01-03 09:00:00' , 2, 'D1gvDteD24HcY5Zc2N53', '가아아아아평', '2023-08-10', '2023-08-15');
insert into room_info(room_id, created_at, location, room_expired_time, room_image, room_invite_code, room_name, travel_end_date, tarvel_start_date)
values (2, '2023-01-04 09:00:00', '부산시', '2023-01-04 09:00:00' , 3, 'K1vGh36D5DQvxv7az8nq', '부우우우우산', '2023-12-25', '2023-12-26');
insert into room_info(room_id, created_at, location, room_expired_time, room_image, room_invite_code, room_name, travel_end_date, tarvel_start_date)
values (3, '2023-01-01 09:00:00', '광양시', '2023-01-01 09:00:00' , 1, 'YUHywrA8qPKeZFZvqqzH', '광양에서 불고기먹자', '2023-06-11', '2023-06-15');
insert into room_info(room_id, created_at, location, room_expired_time, room_image, room_invite_code, room_name, travel_end_date, tarvel_start_date)
values (4, '2023-01-02 09:00:00', '순천시', '2023-01-02 09:00:00' , 1, 'KWOENdA8qPKeZFZvqqzH', '여수에서 간장게장', '2023-06-25', '2023-06-26');
